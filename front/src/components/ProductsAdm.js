...
export const ProductsAdm = ({productsAdm}) => {
          ...
          <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
              <div className='card p-3 rounded'>
                ...
                <div className='card-body d-flex flex-column'>
                    ...
                    <p className='card-text'>$ 16.000</p><a class="btn btn-primary" href="http://localhost:3000/ProductsAdmin" role="button">Editar</a>
                </div>
              </div>
            </div>
            {/*Producto 2*/}
            <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
              <div className='card p-3 rounded'>
                ...
                <div className='card-body d-flex flex-column'>
                    ...
                    <p className='card-text'>$ 18.500</p><a class="btn btn-primary" href="http://localhost:3000/ProductsAdmin" role="button">Editar</a>
                </div>
              </div>
            </div>
            {/*Producto 3*/}
            <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
              <div className='card p-3 rounded'>
                ...
                <div className='card-body d-flex flex-column'>
                    ...
                    <p className='card-text'>$ 14.300</p><a class="btn btn-primary" href="http://localhost:3000/ProductsAdmin" role="button">Editar</a>
                </div>
              </div>
            </div>
            {/*Producto 4*/}
            <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
              <div className='card p-3 rounded'>
                ...
                <div className='card-body d-flex flex-column'>
                    ...
                    <p className='card-text'>$ 22.500</p><a class="btn btn-primary" href="http://localhost:3000/ProductsAdmin" role="button">Editar</a>
                </div>
              </div>
            </div>
             {/*Producto 1*/}
